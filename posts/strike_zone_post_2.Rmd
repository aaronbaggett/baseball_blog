...
Here's [the final report](http://mreed.umtri.umich.edu/mreed/downloads/anthro/ansur/Gordon_1989.pdf) from the U.S. Army Anthropometric Survey.
...
```{r, eval = FALSE, fig.align = 'center', fig.height = 6}
...
```{r, eval = FALSE, echo = FALSE, fig.align='center', fig.height = 7, fig.width = 7}
